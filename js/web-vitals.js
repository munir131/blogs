  ...
  var t,
    ...
    c = function (e, t) {
      u ||
        ...
        (addEventListener("beforeunload", function () {}), (u = !0));
      addEventListener(
        "visibilitychange",
        function n(i) {
          "hidden" === document.visibilityState &&
            (e(i), t && removeEventListener("visibilitychange", n, !0));
        },
        !0,
      );
    },
    ...
    g = new Date(),
    h = function (e, a) {
      t || ((t = a), (n = e), (i = new Date()), b(removeEventListener), S());
    },
    S = function () {
      if (n >= 0 && n < i - g) {
        var e = {
  ...
  ((e.getCLS = function (e, t) {
        ...
        u = o("paint", function (e) {
          "first-contentful-paint" === e.name &&
            ...
            e.startTime < i.timeStamp &&
              ((a.value = e.startTime), a.entries.push(e), f.add(a), n()));
        });
      u &&
        ((n = d(e, a, t)),
        s(function (i) {
    ...
    (e.getLCP = function (e, t) {
      ...
      if (m) {
        n = d(e, a, t);
        var p = function () {
          f.has(a) || (m.takeRecords().map(u), m.disconnect(), f.add(a), n());
        };
